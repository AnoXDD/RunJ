...
namespace RunJ {
    ...
    public class TaskbarManager {
        ...
        private static void ToggleVisibility(bool? visible = null) {
            var newVisible = visible ?? !_isVisible;
            ...
            ShowWindow(taskbar, newVisible ? CONST_SHOW : CONST_HIDE);
            ShowWindow(startmenu, newVisible ? CONST_SHOW : CONST_HIDE);
